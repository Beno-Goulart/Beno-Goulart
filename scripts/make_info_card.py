...
ROWS = [
    ("host",),
    ("sec", "Stack"),
    ("kv", "Languages", "Python, Java, Kotlin, C#, JS, VB, R, CSS, HTML"),
    ("kv", "Backend", "Spring Boot, Node.js"),
    ("kv", "Frontend", "HTML, CSS, JavaScript"),
    ("kv", "DB", "MySQL"),
    ("kv", "Cloud", "AWS"),
    ("kv", "DevOps", "Docker, Git, Linux"),
    ("kv", "Other", "Alteryx"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Full Stack Developer"),
    ("bul", "Java & Spring Boot specialist"),
    ("bul", "Open Source Enthusiast"),
]
